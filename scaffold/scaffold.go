...
var templateFiles = []templateFile{
	...
	// deps/deps.go is the shared typed dependency graph. newAgent constructs it
	// once and passes it to receiver-based handlers, tools, and services.
	{"templates/deps.go.tmpl", "deps/deps.go"},
