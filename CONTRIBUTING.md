...
Thanks for considering a contribution to agentsdk.

## License

agentsdk is licensed under the [Apache License, Version 2.0](LICENSE). By submitting a contribution, you agree it will be made available under the same license.

This project is part of a multi-repo open-source effort alongside [airlock](https://github.com/airlockrun/airlock) (AGPL-3.0), [goai](https://github.com/airlockrun/goai), and [sol](https://github.com/airlockrun/sol). The companion repositories have their own CONTRIBUTING.md.
...
- **Bug reports** — [GitHub Issues](https://github.com/airlockrun/agentsdk/issues). Please include a minimal reproducer.
- **API change proposals** — [GitHub Discussions](https://github.com/airlockrun/agentsdk/discussions) first, before any PR.
